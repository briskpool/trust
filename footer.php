<footer class="default-transition rounded-[20px] p-5 [transition-property:background-color,border-color] desktop:rounded-[30px] desktop:p-8 border border-tintBlue bg-baseWhite dark:border-tintBlack dark:bg-lightBlack default-transition mx-auto grid w-full max-w-screen-max px-8 pb-12 pt-8 desktop:mb-10 desktop:grid-cols-[auto,2fr,1fr] desktop:grid-rows-[repeat(3,auto)] desktop:gap-y-8 desktop:!px-20 desktop:!py-12">
            <div class="flex flex-col items-center desktop:ml-6 desktop:items-start desktop:justify-end">
                ...
                <div class="mt-5 flex items-center gap-3 justify-center">
                    <a target="_blank" rel="noopener noreferrer" href="https://facebook.com/trustwalletapp" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite">
                    ...
                    <a target="_blank" rel="noopener noreferrer" href="https://github.com/trustwallet" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite">
                        <svg width="31" height="31" viewBox="0 0 31 31" class="default-transition text-trustBlack dark:text-trustWhite default-transition text-trustBlack dark:text-trustWhite">
                    ...
                    <a target="_blank" rel="noopener noreferrer" href="https://instagram.com/trustwallet" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite">
                        <svg width="31" height="31" viewBox="0 0 31 31" class="default-transition text-trustBlack dark:text-trustWhite default-transition text-trustBlack dark:text-trustWhite">
                    ...
                    <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/trustwallet" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite">
                    ...
                    <a target="_blank" rel="noopener noreferrer" href="https://discord.gg/trustwallet" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite">
                    ...
                    <a target="_blank" rel="noopener noreferrer" href="https://reddit.com/r/trustapp" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite">
                        <svg width="31" height="31" viewBox="0 0 31 31" class="default-transition text-trustBlack dark:text-trustWhite default-transition text-trustBlack dark:text-trustWhite">
                    ...
                    <a target="_blank" rel="noopener noreferrer" href="https://t.me/trustwallet" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite">
                        <svg width="31" height="31" viewBox="0 0 31 31" class="default-transition text-trustBlack dark:text-trustWhite default-transition text-trustBlack dark:text-trustWhite">
                    ...
                    <a target="_blank" rel="noopener noreferrer" href="https://tatrck.com/h/0Hu30uVO0x7R?url=https%3A%2F%2Fwww.tiktok.com%2F%40trustwalletweb3" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite">
                        <svg width="31" height="31" viewBox="0 0 31 31" class="default-transition text-trustBlack dark:text-trustWhite default-transition text-trustBlack dark:text-trustWhite">
                            <rect x="0.461" y="0.461" width="30.0779" height="30.0779" rx="4.71921" style="fill:currentcolor"></rect>
                            <path style="fill:currentcolor" class="default-transition text-trustWhite dark:text-trustBlack" d="M22.789 6.686a4.793 4.793 0 0 1-3.77-0.245V5h-3.445v13.672a2.896 2.896 0 0 1-5.201 1.743l-.002-.001.002.001a2.895 2.895 0 0 1 3.183-4.51v-3.5a6.329 6.329 0 0 0-5.394 10.692 6.33 6.33 0 0 0 10.857-4.424V8.687a8.182 8.182 0 0 0 4.773 1.526V6.79a4.831 4.831 0 0 1-1.003-.104z"></path>
                        </svg>
                    </a>
                </div>
                <!--/$-->
            </div>
            <ul class="mt-8 flex flex-wrap justify-around gap-6 desktop:col-start-2 desktop:col-end-4 desktop:row-start-1 desktop:mt-0 desktop:grid desktop:grid-cols-[repeat(6,1fr)] desktop:gap-7 desktop:justify-self-start">
                <li class="w-fit max-w-[110px] desktop:max-w-none">
                    <strong class="default-transition text-lightBlack font-inter dark:text-trustWhite text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium">Wallet</strong>
                    <nav class="mt-4 grid gap-2">
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/download">Mobile App</a>
                        <!--/$-->
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/browser-extension">Browser Extension</a>
                        <!--/$-->
                    </nav>
                </li>
                <li class="w-fit max-w-[110px] desktop:max-w-none">
                    <strong class="default-transition text-lightBlack font-inter dark:text-trustWhite text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium">Features</strong>
                    <nav class="mt-4 grid gap-2">
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/buy-crypto">Buy Crypto</a>
                        <!--/$-->
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/swap">Swaps</a>
                        <!--/$-->
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/staking">Staking</a>
                        <!--/$-->
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/nft">NFTs</a>
                        <!--/$-->
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/security">Security</a>
                        <!--/$-->
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/swift">SWIFT: Smart Contract Wallet</a>
                        <!--/$-->
                    </nav>
                </li>
                <li class="w-fit max-w-[110px] desktop:max-w-none">
                    <strong class="default-transition text-lightBlack font-inter dark:text-trustWhite text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium">Build</strong>
                    <nav class="mt-4 grid gap-2">
                        <a target="_blank" rel="noopener noreferrer" href="https://developer.trustwallet.com/developer/" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block">Developer Docs</a>
                        <a target="_blank" rel="noopener noreferrer" href="https://developer.trustwallet.com/developer/wallet-core" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block">Wallet Core</a>
                        <a target="_blank" rel="noopener noreferrer" href="https://developer.trustwallet.com/developer/listing-new-dapps" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block">Submit dApp</a>
                        <a target="_blank" rel="noopener noreferrer" href="https://developer.trustwallet.com/developer/listing-new-assets" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block">Get assets listed</a>
                    </nav>
                </li>
                <li class="w-fit max-w-[110px] desktop:max-w-none">
                    <strong class="default-transition text-lightBlack font-inter dark:text-trustWhite text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium">Support</strong>
                    <nav class="mt-4 grid gap-2">
                        <a target="_blank" rel="noopener noreferrer" href="https://community.trustwallet.com/c/helpcenter/8" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block">FAQ</a>
                        <a target="_blank" rel="noopener noreferrer" href="https://community.trustwallet.com/" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block">Community Forum</a>
                        <a target="_blank" rel="noopener noreferrer" href="https://support.trustwallet.com/en/support/home" class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block">Contact Us</a>
                    </nav>
                </li>
                <li class="w-fit max-w-[110px] desktop:max-w-none">
                    <strong class="default-transition text-lightBlack font-inter dark:text-trustWhite text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium">About</strong>
                    <nav class="mt-4 grid gap-2">
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/about-us">About Us</a>
                        <!--/$-->
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/careers">Careers</a>
                        <!--/$-->
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/press">Press Kit</a>
                        <!--/$-->
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/terms-of-service">Terms of Service</a>
                        <!--/$-->
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/privacy-policy">Privacy Policy</a>
                        <!--/$-->
                        <!--$-->
                        <a class="default-transition flex items-center gap-3 font-inter text-mobileBodyMedium leading-mobileBodyMedium tablet:text-desktopBodyMedium tablet:leading-desktopBodyMedium text-trustBlack hover:underline dark:text-trustWhite block" href="https://trustwallet.com/blog">Blog</a>
                        <!--/$-->
                    </nav>
                </li>
                <li>
                    <div class="flex justify-center gap-x-3 gap-y-5 tablet:gap-x-3">
                        <img alt="A-LIGN ISO 27701" loading="lazy" width="58" height="74" decoding="async" data-nimg="1" class="h-auto w-[58px]" style="color:transparent" src="./Trust2_files/image.8354ab2c.svg">
                        <img alt="A-LIGN ISO 27001" loading="lazy" width="58" height="74" decoding="async" data-nimg="1" class="h-auto w-[58px]" style="color:transparent" src="./Trust2_files/image.7f0b3bc9.svg">
                    </div>
                </li>
            </ul>
            <div class="mt-8 text-center desktop:col-start-2 desktop:row-start-2 desktop:row-end-4 desktop:mt-0 desktop:block desktop:text-left">
                ...
                <div class="flex max-w-[330px] flex-wrap gap-3 desktop:max-w-none">
                    ...
                    <a target="_blank" class="px-5 py-2.5 h-9 default-transition relative z-10 overflow-hidden flex items-center justify-center gap-3 rounded-full text-center text-mobileButton font-medium leading-mobileButton bg-transparent border text-trustBlue border-trustBlue dark:text-trustGreen dark:border-trustGreen | hover:bg-trustBlue hover:text-trustWhite dark:hover:text-trustBlack dark:hover:bg-trustGreen w-full !text-[13px] desktop:w-fit" href="https://chrome.google.com/webstore/detail/trust-wallet/egjidjbpglichdcondbcbdnbeeppgdph">
                        Download Extension<img alt="Chrome" loading="lazy" width="71" height="71" decoding="async" data-nimg="1" class="h-[18px] w-auto" style="color:transparent" src="./Trust2_files/raw.7dd85797.svg">
                    </a>
                    <!--$-->
                    <a class="px-5 py-2.5 h-9 default-transition relative z-10 overflow-hidden flex items-center justify-center gap-3 rounded-full text-center text-mobileButton font-medium leading-mobileButton bg-transparent border text-trustBlue border-trustBlue dark:text-trustGreen dark:border-trustGreen | hover:bg-trustBlue hover:text-trustWhite dark:hover:text-trustBlack dark:hover:bg-trustGreen w-full !text-[13px] desktop:w-fit" href="https://trustwallet.com/download/apk">
                        Download APK
                        <svg width="20" height="23" viewBox="0 0 20 23" fill="none" class="h-[18px] w-auto">
                    ...
                    <a target="_blank" class="px-5 py-2.5 h-9 default-transition relative z-10 overflow-hidden flex items-center justify-center gap-3 rounded-full text-center text-mobileButton font-medium leading-mobileButton bg-transparent border text-trustBlue border-trustBlue dark:text-trustGreen dark:border-trustGreen | hover:bg-trustBlue hover:text-trustWhite dark:hover:text-trustBlack dark:hover:bg-trustGreen w-full !text-[13px] desktop:w-fit" href="https://play.google.com/store/apps/details?id=com.wallet.crypto.trustapp">
                        Download for Android<img alt="App Store" loading="lazy" width="86" height="77" decoding="async" data-nimg="1" class="h-[18px] w-auto" style="color:transparent" src="./Trust2_files/image(3).png">
                    </a>
                </div>
            </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
              const menuButton = document.getElementById('headlessui-switch-:Raalda:');
          
              if (!menuButton) {
                return;
              }
          
              // Find all the <span> elements inside the menuButton
              const menuButtonSpans = menuButton.querySelectorAll('span');
          
              // Add event listener for the menu button
              menuButton.addEventListener('click', () => {
                // Find all elements inside <header> with data-isopen attribute
                const menuItems = document.querySelectorAll('header [data-isopen]');
                
                // Toggle data-isopen for the menu items
                if (menuItems.length > 0) {
                  menuItems.forEach(item => {
                    const isOpen = item.getAttribute('data-isopen') === 'true';
                    const newState = isOpen ? 'false' : 'true';
                    item.setAttribute('data-isopen', newState);
                  });
                }
          
                // Toggle data-checked for <span> elements inside the button
                if (menuButtonSpans.length > 0) {
                  menuButtonSpans.forEach(span => {
                    const spanState = span.getAttribute('data-checked') === 'true';
                    const spanNewState = spanState ? 'false' : 'true';
                    span.setAttribute('data-checked', spanNewState);
                  });
                }
          
                // Optionally, toggle the overflow-hidden class on the document element (for hiding scroll)
                const isMenuOpen = menuItems.length > 0 && menuItems[0].getAttribute('data-isopen') === 'true';
                document.documentElement.classList.toggle('overflow-hidden', isMenuOpen);
              });
            });
          </script>  <!--End Mobile Menu Opener-->
          
       <!--Dark theme switcher -->
          <script>
              document.addEventListener("DOMContentLoaded", function() {
    const themeToggleButtonmob = document.getElementById("themeToggleButtonmob");
    ...
    // Add an event listener for the mobile theme toggle button
    themeToggleButtonmob.addEventListener("click", () => {
        htmlElement.classList.toggle("dark");
    });

    // Add an event listener for the desktop theme toggle button
